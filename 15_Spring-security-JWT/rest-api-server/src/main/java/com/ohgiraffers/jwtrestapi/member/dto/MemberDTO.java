...
public class MemberDTO implements UserDetails {
    ...
    public MemberDTO(int memberCode, String memberEmail, String memberId, String memberName, String memberPassword, List<MemberRoleDTO> memberRole) {
    ...
    //===============================================================================
    // 위는 평범한 DTO 아래는 security 구현을 위한 implments 된 UserDetails 를 위한 정보
