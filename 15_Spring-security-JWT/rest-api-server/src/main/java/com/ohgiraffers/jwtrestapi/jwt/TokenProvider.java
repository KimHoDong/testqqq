...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 30; // 1초 * 60초 * 1800초

    /*Spring Security 가 제공하는 UserDetailsService를 그대로 활용*/
    private final UserDetailsService userDetailsService;
    /*java.security.Key 로 import 할 것*/
    ...
    public TokenProvider(@Value("${jwt.secret}") String secretKey,
        ...
        // 이후, 전달된 secretKey를 Base64 디코딩해서 JWT서명에 사용할 Key 객체를 생성 및 초기화.
    ...
    /*목차. 2. 토큰에 등록된 클레임의 sub 에서 해당 회원의 아이디를 추출*/
    ...
    /*목차. 3. AccessToken 으로 인증 객체 추출( 이 클래스의 5번 과 2번에 해당하는 메소드를 사용)*/
